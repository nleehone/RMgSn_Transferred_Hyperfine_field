# Configuration file for NdMgSn at T=4 K with magnetic moments canted 65 degrees away from
# The k-vector is (0, 0, 1) (commensurate) and the magnetic structure shows first and third harmonics
...
a = 4.454  # a lattice constant (Angstrom)
b = 4.454  # b lattice constant (Angstrom)
c = 16.105  # c lattice constant (Angstrom)
z_R = 0.334  # Position of the rare earth atom in cell units
z_Sn = 0.132  # Position of the Sn atom in cell units

num_cells_a = 10  # Number of unit cells to create along a
num_cells_b = 10  # Number of unit cells to create along b
num_cells_c = 10  # Number of unit cells to create along c
