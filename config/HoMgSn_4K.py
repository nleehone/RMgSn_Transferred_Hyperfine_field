# Configuration file for HoMgSn at T=4 K with magnetic moments aligned in the basal plane
...
a = 4.391  # a lattice constant (Angstrom)
b = 4.391  # b lattice constant (Angstrom)
c = 15.856  # c lattice constant (Angstrom)
z_R = 0.339  # Position of the rare earth atom in cell units
z_Sn = 0.131  # Position of the Sn atom in cell units
